...
INSERT INTO [Customers] (CustomerName, ContactName, Address, City, PostalCode, Country) VALUES ("The Shire", "Bilbo Baggins", "1st Hobbit-Hole", "Bag End", 111, "Middle Earth");
...
SELECT SUM(total) FROM(SELECT COUNT(DISTINCT City) AS total FROM [Customers] GROUP BY City)
